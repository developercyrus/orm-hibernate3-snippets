 ...
 * @see orm.hibernate.one2many.example1.gen.Language
    ...
    public Language findById( int id) {
        ...
        try {
            Language instance = (Language) sessionFactory.getCurrentSession()
                    .get("orm.hibernate.one2many.example1.gen.Language", id);
            if (instance==null) {
    ...
    public List findByExample(Language instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("orm.hibernate.one2many.example1.gen.Language")
