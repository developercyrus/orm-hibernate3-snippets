 ...
 * @see orm.hibernate.one2many.example1.gen.Student
    ...
    public Student findById( java.lang.Integer id) {
        ...
        try {
            Student instance = (Student) sessionFactory.getCurrentSession()
                    .get("orm.hibernate.one2many.example1.gen.Student", id);
            if (instance==null) {
    ...
    public List findByExample(Student instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("orm.hibernate.one2many.example1.gen.Student")
